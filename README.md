...
It demonstrates how messages can be exchanged and coordinated between multiple threads using the [GPI-2 API](https://github.com/cc-hpc-itwm/GPI-2), an implementation of the [GASPI specification](http://gaspi.de/).
